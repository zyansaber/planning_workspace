    ...
    <Card className="mb-6">
      ...
      <CardContent className="space-y-6">
        ...
        <form onSubmit={save} className="grid gap-4 rounded-lg border bg-gray-50 p-4 md:grid-cols-[1fr_1fr_auto] md:items-end">
          <div><Label htmlFor="account-email">Email</Label><Input id="account-email" type="email" required value={email} onChange={(event) => setEmail(event.target.value)} placeholder="name@regentrv.com.au" /></div>
